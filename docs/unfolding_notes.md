...
- Just to be explicit on how to implement the above point, I mean:
...
- NOTE: If your efficiency correction is huge, it will make experimentalists nervous since the more you correct, the more model dependence you include. You can get out of this if you can show that the trend is model independent, but that can be trickier.
