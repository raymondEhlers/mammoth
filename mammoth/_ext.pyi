...
def fast_sim_tracking_efficiency(track_pt: npt.NDArray[np.float64], track_eta: npt.NDArray[np.float64], centrality_bin: TrackingEfficiencyEventActivity, period: TrackingEfficiencyPeriod) -> object: ...
