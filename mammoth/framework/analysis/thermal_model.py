...
def _transform_inputs(source_index_identifiers: Mapping[str, int], arrays: ak.Array, mass_hypothesis: float = 0.139, particle_columns: Optional[Sequence[str]] = None) -> ak.Array:
    # Setup
