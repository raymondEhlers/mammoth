...
def _run_data_skim(
    ...
    try:
        result = analysis_track_skim_to_flat_tree.hardest_kt_data_skim(
            ...
            loading_data_rename_levels=loading_data_rename_levels,
        ...
        for input_filename in input_filenames:
            ...
            results.append(
                _run_data_skim(
                    ...
                    loading_data_rename_levels=_metadata_config["loading_data_rename_levels"],
                    track_skim_to_flat_skim_level_names=_analysis_config["track_skim_to_flat_skim_level_names"],
                    pt_hat_bin=pt_hat_bin,
                    scale_factors=scale_factors,
                    det_level_artificial_tracking_efficiency=det_level_artificial_tracking_efficiency,
                    job_framework=job_framework,
