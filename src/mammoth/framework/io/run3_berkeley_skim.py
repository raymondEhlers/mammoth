"""Berkeley track skim for Run 3 data
...
class Columns:
    ...
    def create(cls, collision_system: str) -> Columns:
        ...
        #  "cluster_data_ncells",
        #  "cluster_data_time",
        #  "cluster_data_isexotic",
        #  "cluster_data_distancebadchannel",
        #  "cluster_data_nlm",
        ...
        _base_particle_columns = {
            ...
            "{prefix}_eta": "eta",
            "{prefix}_phi": "phi",
            "{prefix}_tracksel": "track_selection",
        }
        ...
        if collision_system in ["pythia", "pp_MC", "PbPb_MC"]:
            ...
            del particle_columns["track_data_particle_ID"]
