...
# %%
hetGPMSE = pd.read_csv("Hadron_HETGP_Prediction by bin.csv")
hetGPMSE
...
# %%
HFGPMSE = pd.read_csv("Hadron_HFGP_Prediction by bin.csv")
HFGPMSE
...
# %%
hetGPMSE = pd.read_csv("Jet_HETGP_Prediction by bin.csv")
hetGPMSE
...
# %%
HFGPMSE = pd.read_csv("Jet_HFGP_Prediction by bin.csv")
HFGPMSE
